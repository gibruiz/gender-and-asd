...
df <- subset(df, AGE>=18) #faixa etaria
attach(df)
...
write.table(format(results_1m1fdr, digits = 5, scientific = F),"18_24Modelo1.csv", sep = ",", row.names = F, quote = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)")) #salva cada tabela com o nome correspondente
write.table(format(results_1m2fdr, digits = 5, scientific = F),"18_24M1Sex.csv", sep = ",", row.names = F, quote = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
write.table(format(results_1m3fdr, digits = 5, scientific = F),"18_24M1Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_2m1fdr, digits = 5, scientific = F),"18_24M2Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)")) #salva cada tabela com o nome correspondente
write.table(format(results_2m2fdr, digits = 5, scientific = F),"18_24M2Sex.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_3m1fdr, digits = 5, scientific = F),"18_24Modelo3.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)")) #salva cada tabela com o nome correspondente
write.table(format(results_3m2fdr, digits = 5, scientific = F),"18_24M3Sex.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
write.table(format(results_3m3fdr, digits = 5, scientific = F),"18_24M3Sex_site_totalV.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_4m1fdr, digits = 5, scientific = F),"18_24Modelo4.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)")) #salva cada tabela com o nome correspondente
write.table(format(results_4m2fdr, digits = 5, scientific = F),"18_24M4Sex.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
write.table(format(results_4m3fdr, digits = 5, scientific = F),"18_24M4Sex_site_totalV.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_5m1fdr, digits = 5, scientific = F),"18_24Modelo5.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)")) #salva cada tabela com o nome correspondente
write.table(format(results_5m2fdr, digits = 5, scientific = F),"18_24M5Sex.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
write.table(format(results_5m3fdr, digits = 5, scientific = F),"18_24M5Sex_site_totalV.csv", quote = F, sep = ",", row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
