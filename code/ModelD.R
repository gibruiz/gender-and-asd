...
for (i in 1:62){ #for pra fazer cada modelo usando cada roi
  m1_1 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df6_10[,i+32], data=df6_10)
  m2_1 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df6_10[,i+32] + SEX, data=df6_10)
  m3_1 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df6_10[,i+32] + SEX + SITE_ID + TOTAL_VOLUME, data=df6_10)
...
write.table(format(results_m5_1fdr, digits = 5, scientific = F),"6_10M_D_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
# Completes blank table with coefficients from linear model
for (i in 1:62){ #for pra fazer cada modelo usando cada roi
  m1_2 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df11_14[,i+32], data=df11_14)
  m2_2 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df11_14[,i+32] + SEX, data=df11_14)
  m3_2 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df11_14[,i+32] + SEX + SITE_ID + TOTAL_VOLUME, data=df11_14)
...
write.table(format(results_m5_2fdr, digits = 5, scientific = F),"11_14M_D_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
# Completes blank table with coefficients from linear model
for (i in 1:62){ #for pra fazer cada modelo usando cada roi
  m1_3 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df15_17[,i+32], data=df15_17)
  m2_3 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df15_17[,i+32] + SEX, data=df15_17)
  m3_3 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df15_17[,i+32] + SEX + SITE_ID + TOTAL_VOLUME, data=df15_17)
...
write.table(format(results_m5_3fdr, digits = 5, scientific = F),"15_17M_D_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
# Completes blank table with coefficients from linear model
for (i in 1:62){ #for pra fazer cada modelo usando cada roi
  m1_4 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df18_24[,i+32], data=df18_24)
  m2_4 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df18_24[,i+32] + SEX, data=df18_24)
  m3_4 <-lm(ADI_R_VERBAL_TOTAL_BV ~ df18_24[,i+32] + SEX + SITE_ID + TOTAL_VOLUME, data=df18_24)
...
write.table(format(results_m5_4fdr, digits = 5, scientific = F),"18_24M_D_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
