...
write.table(format(results_m5_1fdr, digits = 5, scientific = F),"6_10M_C_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_m5_2fdr, digits = 5, scientific = F),"11_14M_C_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_m5_3fdr, digits = 5, scientific = F),"15_17M_C_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
...
write.table(format(results_m5_4fdr, digits = 5, scientific = F),"18_24M_C_Sex_site_totalV.csv", sep = ",", quote = F, row.names = F, col.names = c("ROI name", "Estimate", "Std. Error", "t value", "p-value (FDR corrected)"))
